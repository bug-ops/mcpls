...
- `resources/subscribe`/`unsubscribe` now reject requests served over rmcp's stateless per-request HTTP path with an explicit error instead of silently dropping the subscription. (#482)
