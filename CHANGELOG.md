...
- Fixed `get_code_actions` silently dropping edits from language servers that respond with `WorkspaceEdit.documentChanges` instead of the legacy `changes` map. (#429)
